...
public class CharacterData {
    ...
    public static String getFieldValue(Character character, String fieldName) {
        ...
        if (fieldName.equals("name")) {
            ...
            theValue = character.getAlignment();
        } else if (fieldName.equals("background")) {
            theValue = character.getBackground();
        } else if (fieldName.equals("classInfo")) {
            theValue = character.getClassInfo();
    ...
    public static ArrayList<Character> findByValue(String value, Iterable<Character> allCharacters) {
        ...
        for (Character character : allCharacters) {
            ...
            if(character.getName().toLowerCase().contains(value.toLowerCase())) {
                results.add(character);
            } else if(character.getAlignment().toLowerCase().contains(value.toLowerCase())) {
                results.add(character);
            } else if(character.getBackground().toLowerCase().contains(value.toLowerCase())) {
                results.add(character);
            } else if(character.getClassInfo().toLowerCase().contains(value.toLowerCase())) {
                results.add(character);
                ...
                results.add(character);
            } else if(character.getRace().toLowerCase().contains(value.toLowerCase())) {
                results.add(character);
