...
import { armorArray, magicArmorArray, weaponArray, magicWeaponArray, treasures } from './characterdata.jsx';
...
export default function CreateCharacterForm() {
  ...
  function ArmorWeight(armor) {
    ...
    } else if(armorArray.indexOf(armor) >= 3 && armorArray.indexOf(armor) >= 7) {
  ...
  return (
    <div id="characters">
      <h1><strong><u>Welcome to the 404-Found Unofficial Character Sheet!</u></strong></h1>
      <form onSubmit={handleSubmit}>
      <br />
      <br />
      <h3><u><strong>First off, every new adventurer needs a name.</strong></u></h3>
      <br />
        ...
        <hr />
        <br />
        <h3><u><strong>Now that we know who you are, tell us a little about yourself!</strong></u></h3>
        <br />
        <h4>Class defines what skills a character has. Think of class as what your character's calling is.</h4>
        <h4>Selecting a class from the drop down below will show you some of their areas of proficiency.</h4>
        <label htmlFor="classCharacter"><strong>Class: </strong></label>
        <select
          id="characterClass"
        ...
        {selectedClassData && (
          ...
          <container class="class">
               <label htmlFor="proficiencies"><u>Proficiencies:</u></label>
               <ul>
                {selectedClassData.proficiency_choices[0].from.options.map((option, index) =>
                                     option.item.name && <li key={index} value={option.item.name}>{option.item.name}</li>
                                      )}
                </ul>
                <img src="./classes.jpg" height="500" width="700"></img>
          </container>
                <h2>Link to D&D Wiki for more information for more information about your selected class: {<a href="https://www.dandwiki.com/wiki/5e_SRD:Classes" target="_blank"> {selectedClassData.name} </a>}</h2>
          </div>
          )}
        <br />
        <hr />
        ...
        <h4><u>Enter your Race below</u></h4>
        ...
        {selectedRaceData && (
                  <div>
                       ...
                       <ul>
                       <li><h4><u>Disposition:</u></h4> {selectedRaceData.alignment}</li>
                        {selectedRaceData.map = (item) => (
                                <li key={item}>{item.alignment}</li>
                        )}
                        <li><h4><u>Longevity:</u></h4> {selectedRaceData.age}</li>
                        {selectedRaceData.map = (item) => (
                                <li key={item}>{item.age}</li>
                        )}
                        <li><h4><u>Size:</u></h4> {selectedRaceData.size_description}</li>
                         {selectedRaceData.map = (item) => (
                         ...
                         <br />
                         <h2>Link to D&D Wiki for more information for more information about your selected race: {<a href="https://www.dandwiki.com/wiki/5e_SRD:Classes" target="_blank"> {selectedRaceData.name} </a>}</h2>
                  </div>
                  )}
        <br />
        <hr />
        ...
        <br />
        <hr />
        <h2>Write your Character's Custom Background Below in 1000 characters or less: </h2>
        <label htmlFor="backgroundCharacter"><strong>Background:</strong></label>
        <input
          class="background"
          id="background"
          length="1000"
        ...
        <h4>You load-out includes your armors, weapons, special equipment, and a piece of treasure.</h4>
        <br />
        <container>
        ...
        <br />
        <container>
        <h4>2) Now select your magic buffing armor for when you engage in the "Dark Arts" </h4>
        ...
        <br />
        <container>
        <h4>3) Choose a weapon for yourself. Remember, different Classes are better with different weapons!</h4>
        ...
        <br />
        <container>
        <h4>6) Finally, select a piece of Treasure. You never know when it will come in handy!</h4>
        ...
        <br />
        <h4>Refer to the <a href="/Spellbook" target="_blank">Spellbook</a> page for more information on Spells! </h4>
        <br />
        <container class="spells">
        ...
        <label htmlFor="spell2">Second Spell Slot:</label>
                ...
                <br />
                <hr />
        <h1>Once you are satisfied with your choices, press the "Create Character" button to save the results to your account!</h1>
